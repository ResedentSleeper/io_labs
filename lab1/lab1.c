...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Grigoreva & Raskovalova");
MODULE_DESCRIPTION("The first kernel module. Lab 1 Var 1");

static dev_t first;//номер устройства
...
{
	printk(KERN_DEBUG "Write to proc file");
  	return -1;
}
